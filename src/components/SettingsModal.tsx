      ...
      <div className="w-full h-full flex overflow-hidden">
        ...
        <div className="w-[240px] bg-[#141415] border-r border-[#2d2d2e] p-6 flex flex-col justify-between shrink-0">
          <div>
            ...
            <div className="space-y-1">
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-[#2b2b2c] text-amber-400 font-bold text-xs text-left transition-all border border-amber-500/20 shadow-sm shadow-amber-500/5 cursor-pointer">
        ...
        <div className="flex-1 flex flex-col h-full bg-[#1e1e1f] overflow-hidden">
          ...
          <div className="p-6 border-b border-white/5 shrink-0 flex items-center justify-between bg-[#19191a]">
            <div>
              <h1 className="text-lg font-bold text-white tracking-wide">模型 API 提供商配置</h1>
            ...
            <div className="flex items-center gap-4 shrink-0">
              <span className="text-[10px] text-gray-500 font-mono select-none bg-white/5 px-2.5 py-1.5 rounded">ESC 键关闭</span>
              <button 
                onClick={onClose}
